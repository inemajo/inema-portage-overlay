...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/util-linux/util-linux-2.24.1-r3.ebuild,v 1.11 2014/07/09 18:56:58 zlogene Exp $
...
SLOT="0"
IUSE="bash-completion caps +cramfs cytune fdformat ncurses nls pam python selinux slang static-libs +suid test tty-helpers udev unicode inema-custom"
...
src_prepare() {
	...
	if use inema-custom ; then
	        epatch "${FILESDIR}/${P}-agetty.c.inemacustom.patch"
	fi
