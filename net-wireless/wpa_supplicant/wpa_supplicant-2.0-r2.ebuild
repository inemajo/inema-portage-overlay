...
IUSE="ap dbus gnutls eap-sim fasteap p2p ps3 qt4 readline selinux smartcard ssl wimax wps inema-custom kernel_linux kernel_FreeBSD"
...
src_prepare() {
	...
	if use inema-custom; then
	        ...
	        epatch "${FILESDIR}/${P}-wpa_supplicant.c.patch"
	        epatch "${FILESDIR}/${P}-wpa_supplicant_i.h.patch"
	fi
